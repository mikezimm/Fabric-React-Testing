...
//https://developer.microsoft.com/en-us/fabric#/controls/web/calendar#usage
// Just replaced Component<{}, with Component<any,
// ALSO had to add export "default" flag...

export default class CalendarButtonExample extends React.Component<any, ICalendarButtonExampleState> {
